...
export default function RootLayout({
  ...
  const [isOpenTransaksi, setIsOpenTransaks] = useState('');
  const [isOpenTools, setIsOpenTools] = useState('');
      ...
      <body className={inter.className}>
        <div className="navbar bg-base-100">
          <div className="flex-1">
            <a className="btn btn-ghost normal-case text-xl">Buku Warung</a>
          </div>
            ...
            <div className="dropdown dropdown-end">
              <label tabIndex={0} className="btn btn-ghost btn-circle avatar">
                <div className="w-10 rounded-full">
                  <Image src="/images/stock/photo-1534528741775-53994a69daeb.jpg" alt="kosong" width={10} height={20} />
                </div>
              </label>
          ...
          <div className="drawer-side">
            ...
            <ul className="menu p-4 w-80 min-h-full bg-base-200 text-base-content">
              ...
              <li>
                <details open>
                  <summary >
                    <svg className="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 19 20">
                  ...
                  <ul>
                    <li>
                      <a href='/transaksi/penjualan' className={pathname == '/transaksi/penjualan' ? 'active' : ''}>
                        <svg className="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 16">
                    ...
                    <li>
                      <a href='/transaksi/pembelian' className={pathname == '/transaksi/pembelian' ? 'active' : ''}>
                        <svg className="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 16">
                          <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 1v14h16M4 5l3 4 4-4 5 5m0 0h-3.207M16 10V6.793" />
                        </svg>
                        Pembelian
                      </a>
                    </li>
              ...
              <li>
                <a href='/products' className={pathname == '/products' ? 'active' : ''}>
                  <svg className="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 19">
              ...
              <li>
                <details>
                  ...
                  <ul>
                    <li>
                      <a href="/tools/customer" className={pathname == '/tools/customer' ? 'active' : ''}>
                        <svg className="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 19">
                    ...
                    <li>
                      <a href="/tools/brand" className={pathname == '/tools/brand' ? 'active' : ''}>
